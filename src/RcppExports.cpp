...
RcppExport SEXP _qckitW_process_fastq(SEXP infileSEXP, SEXP out_prefixSEXP, SEXP buffer_sizeSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _qckitW_qual_score_per_read(SEXP infileSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _qckitW_gc_per_read(SEXP infileSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type infile(infileSEXP);
...
RcppExport SEXP _qckitW_calc_over_rep_seq(SEXP infileSEXP, SEXP out_prefixSEXP, SEXP min_sizeSEXP, SEXP buffer_sizeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type infile(infileSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_qckitW_process_fastq", (DL_FUNC) &_qckitW_process_fastq, 3},
    {"_qckitW_qual_score_per_read", (DL_FUNC) &_qckitW_qual_score_per_read, 1},
    {"_qckitW_gc_per_read", (DL_FUNC) &_qckitW_gc_per_read, 1},
    {"_qckitW_calc_over_rep_seq", (DL_FUNC) &_qckitW_calc_over_rep_seq, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_qckitW(DllInfo *dll) {
